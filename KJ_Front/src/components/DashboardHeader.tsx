...
import { LogOut, User, Wallet, Bell, CheckCircle2, Sun, Moon } from 'lucide-react';
              ...
              <div className="absolute right-0 mt-3 w-72 z-50">
                ...
                <div className="max-h-72 custom-scroll overflow-y-auto">
                  {[
                    ...
                    { title: 'Cartão atualizado', description: 'Fatura de cartão registrada.' },
                  ].map((item) => (
              ...
              <div className="absolute right-0 mt-3 w-64 z-50">
                ...
                <div className="px-4 py-3 border-t border-gray-800">
                  <button
                    ...
                    className="w-full text-left text-[11px] text-rose-400 hover:text-rose-300 transition-colors"
                  >
                    Sair da conta
                  </button>
                </div>
